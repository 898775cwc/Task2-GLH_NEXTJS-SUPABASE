...
export default function ShipBill() {
  return (
    < /*D.PARENT*/ div className="h-screen flex flex-col justify-items-center items-center">
      ...
      < /*BODY*/ div className="mt-5 flex items-center">
        ...
        < /* RIGHT SECTION*/ div className="ml-10 flex flex-col w-100">
          ...
          <input type="text" id="firstName" placeholder="First Name" className="border border-solid border-black mb-2 mt-2 w-100 rounded-sm" />

          <input type="text" id="surname" placeholder="Surname" className="border border-solid border-black mb-2 w-100 rounded-sm" />

          <input type="text" id="country" placeholder="Country" className="border border-solid border-black mb-2 w-100 rounded-sm" />

          <input type="text" id="add1" placeholder="Address line 1" className="border border-solid border-black mb-2 w-100 rounded-sm" />

          <input type="text" id="add2" placeholder="Address line 2" className="border border-solid border-black mb-2 w-100 rounded-sm" />

          <div className="flex mb-2">
            <input type="text" id="city" placeholder="City" className="border border-solid border-black w-100 rounded-sm mr-1" />
            <input type="text" id="add1" placeholder="Postcode" className="border border-solid border-black w-100 rounded-sm" />
          </div>

          < /*BILLING*/ div className="mt-5 w-101">
            <h1 className="text-lg">Billing Address</h1>
            <input type="checkbox" />
            <label>&emsp;Same as Shipping Address</label>
          </div>

          <button className="bg-winery text-white px-4 py-2 w-35 mt-5 rounded-sm hover:bg-customFore">Edit</button>
