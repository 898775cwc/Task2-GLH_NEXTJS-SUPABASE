  ...
  return (
    < /*D.PARENT*/ div className="h-screen flex flex-col justify-items-center items-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <input type="text" placeholder="First Name" className="border border-solid border-black mb-2 w-100 rounded-sm" />

        <div className="flex">
            <label htmlFor="">Surname:</label>
            <p className="text-red-600">&nbsp;*</p>
        </div>
        <input type="text" placeholder="Surname" className="border border-solid border-black mb-2 w-100 rounded-sm" />
