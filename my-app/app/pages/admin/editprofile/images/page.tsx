      ...
      < /*BODY*/ div className="flex flex-col items-center">
        ...
        <div className="flex mt-5">
          ...
          < /* RIGHT SECTION*/ div className="ml-10 flex flex-col w-100">
            ...
            <div className="flex items-center justify-between mt-5 w-105">

              <div>
                <h1 className="mb-2">Logo image:</h1>
                <h1>Promotional Image:</h1>
              </div>
              <div className="flex flex-col">
                <button className="bg-winery text-white p-1 rounded-sm hover:bg-customFore text-xs flex items-center mr-5 mb-2 "> <FaPlus /> &nbsp; Choose File</button>
                <button className="bg-winery text-white p-1 rounded-sm hover:bg-customFore text-xs flex items-center mr-5"> <FaPlus /> &nbsp; Choose File</button>
              </div>

            </div>

            <p className="text-sm mt-2">These images will be displayed in the main page for your enterprise. Make sue to compress the images if necessary.</p>
