          ...
          < /* RIGHT SECTION*/ div className="ml-10 flex flex-col w-100">
            ...
            <div className="flex items-center justify-between mt-5">
              ...
              <div className="flex flex-col">
                <input type="text" id="facebook" placeholder="e.g. facebook.com/.." className="border border-solid border-black mb-2 w-50 rounded-sm" />
                <input type="text" id="instagram" placeholder="e.g. @user" className="border border-solid border-black mb-2 w-50 rounded-sm" />
                <input type="text" id="linkedin" placeholder="e.g. linkedin.com/in/.." className="border border-solid border-black mb-2 w-50 rounded-sm" />
                <input type="text" id="twitter" placeholder="e.g. @user" className="border border-solid border-black w-50 rounded-sm" />
              </div>
