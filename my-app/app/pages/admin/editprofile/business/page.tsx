/* Page for farmers to edit business details such as the address of the enterprise/farm and legal information pertaining to the legitimacy of the company */
        ...
        <div className="flex mt-5">
          ...
          < /* RIGHT SECTION*/ div className="ml-10 flex flex-col w-100">
            ...
            <div className="flex items-center justify-between mt-5">
              ...
              <div>
                <h1 className="mb-2">Company Number:</h1>
                <h1 className="mb-2">Charges VAT?</h1>
                <h1 className="mb-2">Display logo in invoice?</h1>
                <h1 className="mb-2"></h1>
              </div>
              <div className="flex flex-col">
                <input type="text" id="companyNumber" placeholder="Company Number" className="border border-solid border-black mb-2 w-50 rounded-sm" />
                <div className="mb-2">
                    <input type="radio" id="html" name="owner" value="HTML" />
                    <label>&ensp;Yes&emsp;</label>
                    
                    <input type="radio" id="html" name="owner" value="HTML" />
                    <label>&ensp;No</label>
                </div>
                <div>
                    <input type="checkbox" name="logoInvoice" className="mb-2" />
                </div>
            ...
            <h1>Add text at end of invoice?</h1>
            <textarea name="" id="customtext" className="border border-solid border-black mb-2 w-auto rounded-sm" ></textarea>

            <hr className="mt-5 mb-5" />

            <h1 className="text-3xl">Business Address</h1>

            < /*ADDRESS FORMS*/ div className="flex flex-col mt-5">
              
                <input type="text" id="add1" placeholder="Address Line 1" className="border border-solid border-black mb-2 w-99 rounded-sm" />

                <input type="text" id="add2" placeholder="Address Line 2" className="border border-solid border-black mb-2 w-99 rounded-sm" />

                <div>
                    <input type="text" id="county" placeholder="County" className="border border-solid border-black mb-2 mr-1 w-49 rounded-sm" />
                    <input type="text" id="country" placeholder="Country" className="border border-solid border-black mb-2 w-49 rounded-sm" />
                </div>

                <div>
                    <input type="text" id="city" placeholder="City" className="border border-solid border-black mb-2 mr-1 w-49 rounded-sm" />
                    <input type="text" id="postcode" placeholder="Postcode" className="border border-solid border-black mb-2 w-49 rounded-sm" />
                </div>
