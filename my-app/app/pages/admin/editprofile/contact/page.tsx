/* Page for farmers to add their contact information for customers */
          ...
          < /* RIGHT SECTION*/ div className="ml-10 flex flex-col w-100">
            ...
            <div className="flex items-center justify-between mt-5">
              ...
              <div>
                ...
                <h1 className="mb-2">Public Email Address:</h1>
                <h1 className="mb-2">Phone Number:</h1>
                <h1>Website:</h1>
              </div>
              <div className="flex flex-col">
                <input type="text" id="firstName" placeholder="Name" className="border border-solid border-black mb-2 w-50 rounded-sm" />
                <input type="text" id="publicEmail" placeholder="Public Email Address" className="border border-solid border-black mb-2 w-50 rounded-sm" />
                <input type="text" id="phoneNumber" placeholder="Phone Number" className="border border-solid border-black mb-2 w-50 rounded-sm" />
                <input type="text" id="website" placeholder="Website" className="border border-solid border-black w-50 rounded-sm" />
              </div>
