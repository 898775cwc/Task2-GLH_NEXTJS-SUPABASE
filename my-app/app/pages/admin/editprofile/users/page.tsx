/* Page for farmers to add more users chosen to manage certain parts of the account - permission rights */
      ...
      < /*BODY*/ div className="flex flex-col items-center">
        ...
        <div className="flex mt-5">
          ...
          < /* RIGHT SECTION*/ div className="ml-10 flex flex-col w-100">
            ...
            <p>The users with permission to manage this enterprise.</p>

            <table className="w-100 border border-solid mt-5">
                            <thead>
                            ...
                            <tbody>
                                <tr>
                                    <td className="pl-2 text-sm">Placeholder</td>
                                    <td className="pl-10 text-sm">
                                        <input type="radio" id="html" name="owner" value="HTML" />
                                    </td>
                                    <td className="pl-20 text-sm">
                                        <input type="radio" id="html" name="notifs" value="HTML" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
