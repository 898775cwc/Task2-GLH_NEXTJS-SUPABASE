    ...
    < /*D.HEADER*/ div className="w-screen flex flex-col items-center mt-5 mb-5">
      ...
      < /*BODY*/ div className="flex flex-col items-center h-screen">
        ...
        <div className="w-1/2 mt-5 flex justify-between items-center">
          <h1 className="text-3xl">Edit Products</h1>

          <button className="bg-winery text-white p-1 rounded-sm hover:bg-customFore text-xs flex items-center"> <FaPlus /> &nbsp; New Product</button>
        </div>
        
        <div className="flex flex-col mt-5 w-full items-center justify-center">

            <h1 className="text-lg mb-2">Add Products</h1>
          
            <div className="flex">
                <button className="bg-winery text-white p-1 rounded-sm hover:bg-customFore text-xs flex items-center mr-5"> <FaPlus /> &nbsp; New Product</button>
                <button className="border p-1 rounded-sm hover:bg-customFore text-xs flex items-center"> <FiUpload /> &nbsp; New Products</button>
            </div>
